...
const mockConversations: Conversation[] = [
  {
    ...
    customerImage: "SJ",
    platform: "whatsapp",
    lastMessage: "Yes, please. Thank you!",
    ...
    messages: [
      {
        id: "m1",
        text: "Hi, I'm interested in your organic green tea.",
        sender: "customer",
      ...
      {
        id: "m2",
        text: "Hello! It's $15 for 100g, free shipping over $50.",
        sender: "bot",
      ...
      {
        id: "m3",
        text: "Great, I'd like two packs. Shipping address: 123 Green St.",
        sender: "customer",
      ...
      {
        id: "m4",
        text: "Done — two packs added. Shipping to 123 Green St. Pay on delivery?",
        sender: "bot",
